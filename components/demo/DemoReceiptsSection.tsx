...
const DEMO_RECEIPTS = [
  {
    ...
    category: "Materials",
    items: [
      // Items sum exactly to $847.32 (Oregon — no sales tax)
      { name: "2×4×8 SPF STUD (EA)", qty: 120, unit_price: 4.97, line_total: 596.40 },
      { name: "16D FRAMING NAIL 5LB BOX", qty: 4, unit_price: 12.97, line_total: 51.88 },
      { name: "1/2\" PLYWOOD SHEATHING OSB 4×8", qty: 8, unit_price: 21.63, line_total: 173.04 },
      { name: "JOIST HANGER HUS28 25CT BOX", qty: 1, unit_price: 26.00, line_total: 26.00 },
    ],
  ...
  {
    id: "r2",
    vendor: "Parr Lumber — Milwaukie",
    amount: 2627.80,
    date: "Mar 22, 2026",
    category: "Materials",
    items: [
      // Items sum exactly to $2,627.80
      { name: "GAF TIMBERLINE HDZ SHINGLES 33.3SF", qty: 23, unit_price: 92.00, line_total: 2116.00 },
      { name: "30# FELT UNDERLAYMENT 4SQ ROLL", qty: 6, unit_price: 38.50, line_total: 231.00 },
      { name: "ICE & WATER SHIELD 2SQ ROLL", qty: 2, unit_price: 84.00, line_total: 168.00 },
